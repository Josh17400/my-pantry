/**
 * Migration SQL bodies (drizzle-kit style, statement-breakpoint separated).
 * Source of truth for runtime; `.sql` files under this folder mirror these
 * for drizzle-kit / review tooling.
 */

export const SQL_0000_M0_HEALTH = `
...
export const SQL_0001_PRODUCT_SCHEMA = `
